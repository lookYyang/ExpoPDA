...
/**
 * Created by VULCAN on 2018/5/25.
 */
...
public class TopBar extends LinearLayout {
    ...
    public TopBar(Context context, AttributeSet attrs) {
        ...
        ll = (LinearLayout) findViewById(R.id.top_bar);
        ...
        /**标题相关*/
        title_background_color = typedArray.getColor(R.styleable.TopBar_title_background, Color.WHITE);
        title_text = typedArray.getString(R.styleable.TopBar_title_text);
        title_textColor = typedArray.getColor(R.styleable.TopBar_title_textColor, Color.BLACK);
        title_textSize = typedArray.getColor(R.styleable.TopBar_title_textSize, 22);
        /**返回按钮相关*/
        left_button_imageId = typedArray.getResourceId(R.styleable.TopBar_left_button_image, R.mipmap.left_wite);
        left_button_text = typedArray.getString(R.styleable.TopBar_left_button_text);
        left_button_textColor = typedArray.getColor(R.styleable.TopBar_left_button_textColor, Color.WHITE);
        left_button_textSize = typedArray.getColor(R.styleable.TopBar_left_button_textSize, 20);
        show_left_button = typedArray.getBoolean(R.styleable.TopBar_show_left_button, true);
        /**右边保存按钮相关*/
        right_button_imageId = typedArray.getResourceId(R.styleable.TopBar_right_button_image, 0);
        right_button_text = typedArray.getString(R.styleable.TopBar_right_button_text);
        right_button_textColor = typedArray.getColor(R.styleable.TopBar_right_button_textColor, Color.WHITE);
        right_button_textSize = typedArray.getColor(R.styleable.TopBar_right_button_textSize, 20);
        show_right_button = typedArray.getBoolean(R.styleable.TopBar_show_right_button, true);
        /**设置值*/
