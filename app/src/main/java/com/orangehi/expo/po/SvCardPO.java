 ...
 * 
 * @author yang
 * @date 2018-05-16 11:28:24
 */
public class SvCardPO {
	 ...
	 * 胸牌卡号(自动生成)
	 */
	private String badge_card;
	
	/**
	 * 身份证件类型，枚举id_card_type
	 */
	 ...
	 * @param badge_card
	 */
	public void setBadge_card(String badge_card) {
		this.badge_card = badge_card;
	}
